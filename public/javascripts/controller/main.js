    ...
    '<div class="col-md-10 col-md-offset-1 col-lg-10 col-lg-offset-1">'+
        ...
        '<div id="select-size" class="hide-order-form">'+
            '<div class="col-md-12 text-center m10">'+
                '<span>'+
                    '<a id="play-sample-video" class="btn btn-xs green btn-white">Näin tilaat</a> '+
                    '<a data-toggle="modal" data-target="#compare" class="btn green btn-xs btn-white">Vertaile paketteja</a>'+
                    '<a href="https://www.luovat.com/videotuotanto" class="btn green btn-xs btn-white">Tilausohjeet</a>'+
                '</span>'+
